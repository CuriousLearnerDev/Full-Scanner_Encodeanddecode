...
class tool:
    ...
    def Output_box(self):
        Output_Text = ttk.LabelFrame(top,
                                      text="结果",
                                      bootstyle="success")

        Output_Text.place(y=395,# 上下
                          relwidth=1,
                          relheight=0.4)
        # 创建一个滚动条控件，默认为垂直方向
    ...
    def Input_box(self):
        Input_Text = ttk.LabelFrame(top,
                                      text="输入",
                                      bootstyle="success")

        Input_Text.place(y=120,# 上下
                          relwidth=1,
                          relheight=0.4)
    ...
    def main(self):
        ...
        classification = ttk.LabelFrame(top,
                                      text="编码",
                                      bootstyle="success")

        classification.place(relwidth=1,
                           relheight=0.176)
